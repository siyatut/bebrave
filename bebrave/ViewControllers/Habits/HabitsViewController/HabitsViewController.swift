...
#warning("№2: Когда пользователь создаёт новую привычку, дни, которые он не отметил для выполнения, должны автоматически закрашиваться как скипнутые привычки")
