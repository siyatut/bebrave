...
// swiftlint:disable:next line_length
// TODO: - Не сохраняет состояние, если привычка отмечена как скипнутая. Если закрыть и открыть приложение снова, статус возвращается в положение до скипа привычки
