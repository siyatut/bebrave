...
#warning("№3: Как будто есть баг с сохранением прогресса привычки при перезапуске приложения. UPD: вроде пофиксила, при закрытии и открытии приложения на симуляторе, всё ок. При полной пересборке проекта — нет. Но это кмк ок или нет?")
