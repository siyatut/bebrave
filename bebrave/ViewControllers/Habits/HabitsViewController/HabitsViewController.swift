...
#warning("№1: Доделать: если пользователь решил отменить выполнение, то прогресс должен уменьшиться на 1. Если решил пропустить сегодня, то привычка должна закраситься жёлтым. Если он не выполнил вообще (после 00:00 по таймзоне юзера), то серым.")
